...
[![Node.js CLI Starter logo][Logo url]][Repo url]
...
Starter project for Node.js CLI apps.

[![Node.js CLI Starter screenshot][Node.js CLI Starter screenshot url]][Node.js CLI Starter url]
